...
## Overview
This API supports user management, product management, cart functionality, and order processing. Below is a detailed description of each endpoint, including their HTTP methods, required parameters, and response structures.
